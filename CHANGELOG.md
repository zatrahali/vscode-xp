...
- добавлена возможность обновить окно интеграционных тестов при их изменении файлов на диске, а также предложение о закрытии окна в случае удаления правила;
- переделана схема контроля консистентности графа нормализаций через File Watcher для формул нормализаций.
...
- расширено количество источников событий в редакторе метаданных (special thanks @Andru).
