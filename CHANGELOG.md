...
- локализовано окно корреляции событий;
- локализованы сообщения запуска интеграционных тестов;
- добавлена проверка открытия базы знаний при запуске команд окна _Дерева объектов_;
