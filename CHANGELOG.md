...
- добавлена базовая поддержка правил агрегации: создание из шаблона, тестирование, заполнение метаинформации, описание и локализация (special thanks @Protenil).
