...
suite('TestHelper.formatTestCode', async () => {
	...
	test('Форматирование событий с долларом в коде', async () => {
		...
		const formatted =
`table_list {"Common_whitelist_auto":[{"rule":"RuleName","specific_value":"$payload = ''$hashbytearray = [byte[]] ($payload -replace '..', '0x$&,' -split ',' -ne '')write-eventlog -logname 'key management service' -source kmsrequests -entrytype information -eventid 31337 -category 0 -message 'here be dragons' -rawdata $hashbytearray"}]}`;
